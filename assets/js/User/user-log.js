...
window.initUserLogPage = function() {
  ...
  function fetchUserLogs(page = 1, filters = {}) {
    ...
    if (typeof window !== 'undefined' && window.buildApiUrl) {
      ...
      // Fallback to relative path; api-config.js will rewrite to BASE_URL
      apiUrl = `/api/users/logs?${apiParams.toString()}`;
    }
  ...
  function formatTimestamp(timestamp) {
    ...
    // Otherwise show full date and time in "10:51:25 AM" format
